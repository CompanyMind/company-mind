    ...
    <>
      ...
      <section className="pb-16 pt-[calc(var(--nav-h)+3.5rem)] md:pb-20 md:pt-[calc(var(--nav-h)+5rem)]">
        <div className="shell grid gap-14 lg:grid-cols-[1.4fr_1fr] lg:items-center lg:gap-20">
          <div>
            <p className="mono-label">{securityHero.label}</p>
            <h1 className="mt-6 font-display text-display-lg text-ink">
              {securityHero.headline.map((line, i) => (
              ...
              >
                ...
                <div>
                  ...
                  <p className="mt-6 flex flex-col gap-1.5 border-l-2 border-brain pl-5 sm:flex-row sm:items-baseline sm:gap-4">
                    <span className="mono-label shrink-0 text-brain-text">Verify</span>
      ...
      <section className="py-20 md:py-28">
        <div className="shell">
          <SectionHead
            label={notClaiming.label}
            headline={notClaiming.headline}
            body={notClaiming.body}
          />
          <ul className="mt-14 border-t border-line">
            {notClaiming.items.map((item) => (
              <li
                key={item.claim}
      ...
      <section className="border-t border-line bg-paper-raised py-24 md:py-32">
        <div className="shell max-w-4xl text-center">
          ...
          <div className="mt-10 flex justify-center">
            <MagneticButton href={cta.href} variant="sovereign">
              {cta.label}
            </MagneticButton>
          </div>
          <p className="mt-6 font-mono text-telemetry text-ink-soft">{securityCta.fineprint}</p>
        </div>
      </section>
    </>
  )
