...
export const uz: Dictionary = {
  ...
  chat: {
    ...
    copy: 'Nusxalash',
    copied: 'Nusxalandi',
    uncited: 'Bu javob hech qanday manbaga tayanmaydi. Uni tasdiqlanmagan deb hisoblang va ishonishdan oldin «Manbalar»ni tekshiring.',
    partiallyCited: 'Bu javobdagi {count} ta havola hech qayerga olib bormaydi. Faqat quyida keltirilgan manbalar haqiqiy.',
    openSource: 'Manbani ochish',
    sourceReindexed: 'Hujjat qayta indekslandi; keltirilgan matn saqlanib qoldi.',
    evidenceIdle: 'Savol bering. Javob asoslangan parchalar shu yerda koʻrinadi.',
    evidenceNone: 'Bu javob uchun hujjat kerak boʻlmadi.',
    sources: 'Manbalar',
    retry: 'Qayta urinish',
    send: 'Yuborish',
  ...
  panels: {
    ...
    access: {
      ...
      opens: '{count} ta hujjatni ochadi',
      opensOne: '{count} ta hujjatni ochadi',
      renameGroup: '{name} nomini oʻzgartirish',
      deleteGroupAria: '{name} guruhini oʻchirish',
      deleteGroupConfirm: '{name} oʻchirilsinmi? Aʻzolari {count} ta hujjatga kirish huquqini yoʻqotadi. Hujjatlarning oʻzi qoladi.',
      cancelDelete: 'Qolsin',
    },
    people: {
